...
//     if (originalUrl.startsWith(base + "/")) {
//       return res.status(400).json({ message: "URL is banned" });
//     }
...
//           success: true,
//           message: "URL already shortened",
//           shortUrl: `${base}/api/${existing.shortCode}`,
//           code: existing.shortCode,
//           id: existing._id,
//         });
//       }
...
//         success: true,
//         message: "URL already shortened",
//         shortUrl: `${base}/api/${existingAnon.shortCode}`,
//         code: existingAnon.shortCode,
//         id: existingAnon._id,
//       });
//     }

//     if ((anonUser?.count ?? 0) >= 3) {
//       return res
//         .status(403)
//         .json({ message: "Free limit reached. Please login to continue." });
//     }
...
//       shortUrl: `${base}/api/${shortCode}`,
//       remaining: 3 - ((anonUser?.count ?? 0) + 1),
//       id: saveUrl._id,
//     });
//   } catch (error) {
//     console.error(error);
